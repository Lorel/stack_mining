...
public class PostDatabase {
    ...
    public PostDatabase(Connection connection) throws SQLException {
        ...
        String insertStatement = "INSERT INTO stackoverflow.post(" + ID + ", " + TITLE + ", " + BODY + ", " + ACCEPTED_ANSWER + ", " + DATE + ") VALUES(?, ?, ?, ?, ?)";
        ...
        String insertStackStatement = "INSERT INTO stackoverflow.stack(language) VALUES(?);";
